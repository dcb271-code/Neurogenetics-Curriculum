...
slides.push(slideHTML(MOD, 2, TOTAL, `
  ...
  <div class="card card-accent" style="margin-bottom:20px;">
    <div class="card-title" style="font-size:22px;">Postzygotic Mutations</div>
...
slides.push(slideHTML(MOD, 3, TOTAL, `
  ...
  <div style="font-size:21px; margin-bottom:22px; color:${COLORS.body};">
  ...
  <div style="display:flex; gap:16px; margin-bottom:22px;">
    <div class="card card-red" style="flex:1;">
      <div class="card-title" style="font-size:20px;">Very Early (1-3 divisions)</div>
    ...
    <div class="card card-amber" style="flex:1;">
      <div class="card-title" style="font-size:20px;">Intermediate</div>
      <div class="card-body" style="font-size:17px;">
    ...
    <div class="card card-accent" style="flex:1;">
      <div class="card-title" style="font-size:20px;">Late / Tissue-Specific</div>
      <div class="card-body" style="font-size:17px;">
  ...
  <div class="two-col">
    <div class="card card-green">
      ...
      <div class="card-body" style="font-size:17px;">A second postzygotic event <strong>corrects</strong> the original mutation in a subset of cells. Seen in immunodeficiencies and skin disorders.</div>
    </div>
    <div class="card card-violet">
      <div class="card-title">VAF &ne; Severity</div>
      <div class="card-body" style="font-size:17px;">Variant allele fraction varies by tissue and does <strong>not reliably predict</strong> phenotypic severity on its own.</div>
    </div>
  </div>
`));
...
slides.push(slideHTML(MOD, 4, TOTAL, `
  ...
  <div style="display:grid; grid-template-columns:1fr 1fr 1fr; gap:16px;">
    <div class="card card-accent">
      <div class="card-title" style="font-size:20px;">Mosaic Turner (45,X/46,XX)</div>
      <div class="card-body" style="font-size:17px;">
    ...
    <div class="card card-rose">
      <div class="card-title" style="font-size:20px;">Mosaic Down (47,+21/46,N)</div>
      <div class="card-body" style="font-size:17px;">
    ...
    <div class="card card-amber">
      <div class="card-title" style="font-size:20px;">Trisomy 8 Mosaicism</div>
      <div class="card-body" style="font-size:17px;">
...
slides.push(slideHTML(MOD, 5, TOTAL, `
  ...
  <div class="card card-red" style="margin-bottom:22px;">
    <div class="card-title" style="font-size:22px;">CVS vs Amniocentesis</div>
    <div class="card-body" style="font-size:19px;">
  ...
  <div class="highlight-box">
    ...
    <div class="value" style="font-size:22px;">CPM can cause intrauterine growth restriction even when the fetus is chromosomally normal</div>
  </div>
`));
...
slides.push(slideHTML(MOD, 6, TOTAL, `
  ...
  <div class="card card-accent" style="margin-bottom:20px;">
    <div class="card-title" style="font-size:22px;">Blood Karyotype May Not Reflect Brain or Gonadal Populations</div>
    <div class="card-body" style="font-size:19px;">
  ...
  <div class="highlight-box">
    ...
    <div class="value" style="font-size:22px;">Mosaicism = milder phenotype is a generalization, not a rule &mdash; tissue distribution matters more than percentage</div>
  </div>
`));
...
slides.push(slideHTML(MOD, 7, TOTAL, `
  ...
  <div class="card card-accent" style="margin-bottom:20px;">
    <div class="card-title" style="font-size:22px;">mTOR Pathway Somatic Mutations</div>
    <div class="card-body" style="font-size:19px;">
  ...
  <div style="display:grid; grid-template-columns:1fr 1fr 1fr; gap:16px;">
    <div class="card card-red">
      <div class="card-title" style="font-size:20px;">Gain-of-Function</div>
      <div class="card-body" style="font-size:17px;">
    ...
    <div class="card card-amber">
      <div class="card-title" style="font-size:20px;">Two-Hit Model (LOF)</div>
      <div class="card-body" style="font-size:17px;">
    ...
    <div class="card card-green">
      <div class="card-title" style="font-size:20px;">Detection</div>
      <div class="card-body" style="font-size:17px;">
...
slides.push(slideHTML(MOD, 8, TOTAL, `
  ...
  <div style="display:flex; gap:16px; margin-bottom:22px;">
    <div class="card card-red" style="flex:1;">
      <div class="card-title" style="font-size:20px;">Early &rarr; Hemimegalencephaly</div>
      <div class="card-body" style="font-size:17px;">
    ...
    <div class="card card-amber" style="flex:1;">
      <div class="card-title" style="font-size:20px;">Intermediate &rarr; Multilobar FCD</div>
      <div class="card-body" style="font-size:17px;">
    ...
    <div class="card card-accent" style="flex:1;">
      <div class="card-title" style="font-size:20px;">Late &rarr; Focal FCD</div>
      <div class="card-body" style="font-size:17px;">
        Late progenitor<br>
        Small territory<br>
  ...
  <div class="highlight-box">
    ...
    <div class="value" style="font-size:22px;">Earlier mutation = larger territory = more severe phenotype = higher VAF in tissue</div>
  </div>
`));
...
slides.push(slideHTML(MOD, 9, TOTAL, `
  ...
  <div class="two-col" style="margin-bottom:20px;">
    <div class="card card-red">
      <div class="card-title" style="font-size:22px;">Sturge-Weber Syndrome</div>
      <div class="card-body" style="font-size:18px;">
    ...
    <div class="card card-amber">
      <div class="card-title" style="font-size:22px;">McCune-Albright Syndrome</div>
      <div class="card-body" style="font-size:18px;">
  ...
  <div class="card card-accent">
    <div class="card-title" style="font-size:20px;">Clinical Implication</div>
    <div class="card-body" style="font-size:19px;">
...
slides.push(slideHTML(MOD, 10, TOTAL, `
  ...
  <div class="card card-red" style="margin-bottom:22px;">
    <div class="card-title" style="font-size:22px;">The Hidden Carrier</div>
    <div class="card-body" style="font-size:19px;">
...
slides.push(slideHTML(MOD, 11, TOTAL, `
  ...
  <div class="highlight-box">
    ...
    <div class="value" style="font-size:22px;">CK levels and carrier testing of maternal siblings are important in DMD &mdash; germline mosaicism accounts for ~10% of apparently de novo cases</div>
  </div>
`));
...
slides.push(slideHTML(MOD, 12, TOTAL, `
  ...
  <div class="two-col" style="margin-bottom:20px;">
    <div class="card card-accent">
      <div class="card-title" style="font-size:20px;">Parental Testing Strategy</div>
      <div class="card-body" style="font-size:18px;">
    ...
    <div class="card card-green">
      <div class="card-title" style="font-size:20px;">Reproductive Options</div>
      <div class="card-body" style="font-size:18px;">
  ...
  <div class="highlight-box">
    ...
    <div class="value" style="font-size:22px;">Never quote 0% recurrence risk for apparently de novo dominant conditions &mdash; germline mosaicism is always a possibility</div>
  </div>
`));
...
slides.push(slideHTML(MOD, 13, TOTAL, `
  ...
  <div class="highlight-box">
    ...
    <div class="value" style="font-size:22px;">ddPCR is the gold standard for quantifying known variants at very low VAF (0.01-0.1%)</div>
  </div>
`));
...
slides.push(slideHTML(MOD, 14, TOTAL, `
  ...
  <div class="card card-red" style="margin-bottom:20px;">
    <div class="card-title" style="font-size:22px;">Tissue Selection is Paramount</div>
    <div class="card-body" style="font-size:19px;">
  ...
  <div class="two-col" style="margin-bottom:16px;">
    <div class="card card-accent">
      <div class="card-title" style="font-size:20px;">Brain Disorders</div>
      <div class="card-body" style="font-size:18px;">
    ...
    <div class="card card-amber">
      <div class="card-title" style="font-size:20px;">Skin Disorders</div>
      <div class="card-body" style="font-size:18px;">
