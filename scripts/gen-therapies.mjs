...
slides.push(slideHTML(MOD, 2, TOTAL, `
  ...
  <div class="two-col">
    <div class="card card-accent" style="padding:28px;">
      <div class="card-title" style="font-size:31px;">Gene Addition / Replacement</div>
    ...
    <div>
      <div class="card card-violet" style="padding:24px; margin-bottom:16px;">
        <div class="card-title" style="font-size:28px;">ASO Silencing</div>
      ...
      <div class="card card-rose" style="padding:24px;">
        <div class="card-title" style="font-size:28px;">RNAi Silencing</div>
        <div class="card-body" style="font-size:24px;">
...
slides.push(slideHTML(MOD, 3, TOTAL, `
  ...
  <div class="card card-accent" style="padding:28px; margin-bottom:20px;">
    <div class="card-title" style="font-size:31px;">Gene Editing &mdash; CRISPR-Cas9</div>
    <div class="card-body" style="font-size:25px; margin-top:8px;">
      Guided by sgRNA, creates double-strand break at a specific genomic locus.
    </div>
    <div style="margin-top:14px; font-size:24px; line-height:1.6; color:${COLORS.body};">
...
slides.push(slideHTML(MOD, 4, TOTAL, `
  ...
  <div class="card card-accent" style="padding:28px; margin-bottom:20px;">
    <div class="card-title" style="font-size:31px;">Adeno-Associated Virus (AAV)</div>
...
slides.push(slideHTML(MOD, 5, TOTAL, `
  ...
  <div style="display:grid; grid-template-columns:1fr 1fr; gap:16px;">
    <div class="card card-green" style="padding:20px;">
      <div class="card-title" style="font-size:28px;">Intravenous (IV)</div>
      <div class="card-body" style="font-size:24px;">Crosses BBB in young patients. Requires high dose. Used for Zolgensma in infants.</div>
    </div>
    <div class="card card-violet" style="padding:20px;">
      <div class="card-title" style="font-size:28px;">Intrathecal / ICV</div>
      <div class="card-body" style="font-size:24px;">Reduces dose needed. Bypasses BBB. Spreads via CSF distribution.</div>
    </div>
    <div class="card card-amber" style="padding:20px;">
      <div class="card-title" style="font-size:28px;">Intraparenchymal</div>
      <div class="card-body" style="font-size:24px;">Direct focal delivery. Used in Parkinson and Alzheimer trials.</div>
    </div>
    <div class="card card-rose" style="padding:20px;">
      <div class="card-title" style="font-size:28px;">Intravitreal</div>
      <div class="card-body" style="font-size:24px;">Eye diseases &mdash; LCA / RPE65 (Luxturna).</div>
    </div>
  </div>
`));
...
slides.push(slideHTML(MOD, 7, TOTAL, `
  ...
  <div class="two-col">
    <div class="card card-accent" style="padding:28px;">
      <div class="card-title" style="font-size:31px;">Onasemnogene Abeparvovec (Zolgensma)</div>
      <div class="card-body" style="font-size:24px; margin-top:8px;">
        <strong>AAV9-SMN1</strong> | Single IV infusion | FDA 2019
      </div>
      <div style="margin-top:14px; font-size:24px; line-height:1.6;">
    ...
    <div class="card card-violet" style="padding:28px;">
      <div class="card-title" style="font-size:31px;">Voretigene Neparvovec (Luxturna)</div>
      <div class="card-body" style="font-size:24px; margin-top:8px;">
...
slides.push(slideHTML(MOD, 8, TOTAL, `
  ...
  <div class="numbered-item">
    ...
    <div class="card card-accent" style="flex:1; margin-bottom:0; padding:20px 24px;">
      <div class="card-title" style="font-size:28px;">Delandistrogene Moxeparvovec (Elevidys)</div>
      <div class="card-body" style="font-size:24px;"><strong>AAVrh74-micro-dystrophin</strong> | IV infusion | FDA 2023 (accelerated) for DMD ages 4&ndash;5 years. Uses engineered micro-dystrophin (138 kDa functional mini-protein). Ongoing trials in older patients.</div>
    </div>
  </div>
  ...
  <div class="numbered-item">
    ...
    <div class="card card-violet" style="flex:1; margin-bottom:0; padding:20px 24px;">
      <div class="card-title" style="font-size:28px;">Atidarsagene Autotemcel (Libmeldy)</div>
      <div class="card-body" style="font-size:24px;"><strong>Ex vivo autologous HSC + lentiviral ARSA</strong> | EMA 2020 for metachromatic leukodystrophy in pre-symptomatic or early symptomatic patients. Longest follow-up &gt;10 years &mdash; no neurological progression vs. natural history.</div>
    </div>
  </div>
  ...
  <div class="numbered-item">
    ...
    <div class="card card-green" style="flex:1; margin-bottom:0; padding:20px 24px;">
      <div class="card-title" style="font-size:28px;">Zynteglo &amp; Skysona</div>
      <div class="card-body" style="font-size:24px;">Ex vivo HSC gene therapy for beta-thalassemia and cerebral adrenoleukodystrophy &mdash; establishing the <strong>lentiviral HSC platform</strong> for CNS demyelinating leukodystrophies.</div>
    </div>
  </div>
`));
...
slides.push(slideHTML(MOD, 9, TOTAL, `
  ...
  <div class="highlight-box" style="margin-top:12px;">
    ...
    <div class="value" style="font-size:31px;">Earlier treatment = better outcomes. Patient selection (age, weight, immune status) is critical.</div>
  </div>
`, `
...
slides.push(slideHTML(MOD, 10, TOTAL, `
  ...
  <div class="card card-accent" style="padding:28px; margin-bottom:20px;">
    <div class="card-title" style="font-size:31px;">What Are ASOs?</div>
    <div class="card-body" style="font-size:27px;">
  ...
  <div class="three-col">
    <div class="card card-green" style="padding:22px;">
      <div class="card-title" style="font-size:28px;">RNaseH Degradation</div>
      <div class="card-body" style="font-size:24px;">ASO&ndash;mRNA hybrid recruits RNaseH &rarr; target mRNA cleaved and destroyed (e.g., tofersen for SOD1)</div>
    </div>
    <div class="card card-violet" style="padding:22px;">
      <div class="card-title" style="font-size:28px;">Splice Modulation</div>
      <div class="card-body" style="font-size:24px;">Blocks splicing silencer/enhancer &rarr; forces exon inclusion or skipping (e.g., nusinersen for SMA)</div>
    </div>
    <div class="card card-amber" style="padding:22px;">
      <div class="card-title" style="font-size:28px;">Chemical Modifications</div>
      <div class="card-body" style="font-size:24px;">Phosphorothioate backbone, 2&rsquo;-O-methyl, LNA, PMO &mdash; protect from nucleases, improve affinity</div>
    </div>
  </div>

  <div class="highlight-box" style="margin-top:16px;">
    <div class="label">CNS Delivery</div>
    <div class="value" style="font-size:31px;">Intrathecal ASOs distribute broadly through CSF and penetrate neurons and glia &mdash; no viral vector needed</div>
  </div>
`));
...
slides.push(slideHTML(MOD, 11, TOTAL, `
  ...
  <div class="two-col">
    <div class="card card-accent" style="padding:28px;">
      <div class="card-title" style="font-size:31px;">Nusinersen (Spinraza)</div>
      <div class="card-body" style="font-size:24px; margin-top:8px;">
    ...
    <div class="card card-violet" style="padding:28px;">
      <div class="card-title" style="font-size:31px;">Tofersen (Qalsody)</div>
      <div class="card-body" style="font-size:24px; margin-top:8px;">
...
slides.push(slideHTML(MOD, 12, TOTAL, `
  ...
  <div class="two-col" style="margin-bottom:20px;">
    <div class="card card-green" style="padding:28px;">
      <div class="card-title" style="font-size:31px;">Inotersen &amp; Eplontersen</div>
      <div class="card-body" style="font-size:25px; margin-top:8px;">
      ...
      <div style="margin-top:12px; font-size:24px; color:${COLORS.muted};">
        Patisiran (siRNA) has a similar mechanism and indication.
      </div>
    </div>

    <div class="card card-amber" style="padding:28px;">
      <div class="card-title" style="font-size:31px;">UBE3A-ATS ASO for Angelman Syndrome</div>
      <div class="card-body" style="font-size:25px; margin-top:8px;">
  ...
  <div class="highlight-box">
    ...
    <div class="value" style="font-size:31px;">Reversible, redosable, rapid N-of-1 development possible. Ideal for gain-of-function and splice-modulation targets.</div>
  </div>
`));
...
slides.push(slideHTML(MOD, 13, TOTAL, `
  ...
  <div class="numbered-item">
    ...
    <div class="card card-red" style="flex:1; margin-bottom:0; padding:20px 24px;">
      <div class="card-title" style="font-size:28px;">Pre-Existing AAV Neutralizing Antibodies</div>
      <div class="card-body" style="font-size:24px;">AAV9 NAb &ge;1:50 typically excludes patients from IV gene therapy. Prevalence increases with age (40&ndash;70% of adults). Plasmapheresis to reduce titers is experimental.</div>
    </div>
  </div>
  ...
  <div class="numbered-item">
    ...
    <div class="card card-amber" style="flex:1; margin-bottom:0; padding:20px 24px;">
      <div class="card-title" style="font-size:28px;">Immunosuppression Protocols</div>
      <div class="card-body" style="font-size:24px;">Prednisolone 1 mg/kg/day initiated before and continued weeks after AAV administration to suppress T-cell response to capsid. Anti-CD20 (rituximab) added in high-risk protocols. Liver enzyme monitoring essential.</div>
    </div>
  </div>
  ...
  <div class="numbered-item">
    ...
    <div class="card card-accent" style="flex:1; margin-bottom:0; padding:20px 24px;">
      <div class="card-title" style="font-size:28px;">Episomal Dilution in Growing Livers</div>
      <div class="card-body" style="font-size:24px;">In infants, rapidly dividing hepatocytes dilute episomal rAAV &rarr; decreasing expression over years. Critical limitation for early-treated SMA patients approaching adolescence &mdash; combination with ASO may address durability.</div>
    </div>
  </div>
`));
...
slides.push(slideHTML(MOD, 14, TOTAL, `
  ...
  <div style="display:grid; grid-template-columns:1fr 1fr 1fr; gap:14px;">
    <div class="card card-accent" style="padding:20px;">
      <div class="card-title" style="font-size:25px;">Huntington Disease</div>
      <div class="card-body" style="font-size:22px;">HTT lowering via ASO, siRNA, and CRISPR &mdash; clinical trials underway</div>
    </div>
    <div class="card card-violet" style="padding:20px;">
      <div class="card-title" style="font-size:25px;">Parkinson Disease</div>
      <div class="card-body" style="font-size:22px;">AADC and GAD1/2 gene therapy for symptom modification</div>
    </div>
    <div class="card card-green" style="padding:20px;">
      <div class="card-title" style="font-size:25px;">Rett Syndrome</div>
      <div class="card-body" style="font-size:22px;">MECP2 AAV &mdash; dose-sensitive, narrow therapeutic window</div>
    </div>
    <div class="card card-amber" style="padding:20px;">
    ...
    <div class="card card-rose" style="padding:20px;">
      ...
      <div class="card-body" style="font-size:22px;">APOE4 gene editing. Note: lecanemab is anti-A&beta; mAb, NOT gene therapy</div>
    </div>
    <div class="card card-blue" style="padding:20px;">
      <div class="card-title" style="font-size:25px;">GM1/GM2 Gangliosidosis</div>
      <div class="card-body" style="font-size:22px;">Multiple AAV gene therapy programs in clinical trials</div>
    </div>
  </div>
`));
