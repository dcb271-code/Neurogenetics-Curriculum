...
slides.push(slideHTML(MOD, 2, TOTAL, `
  ...
  <div class="card card-accent" style="margin-bottom:24px; padding:28px;">
    <div class="card-title" style="font-size:24px;">Neurogenetics Defined</div>
  ...
  <div class="highlight-box">
    ...
    <div class="value" style="font-size:22px;">The nervous system is the most commonly affected organ system in Mendelian disease</div>
  </div>
`));
  ...
  <div class="two-col" style="margin-bottom:24px;">
    <div>
      <div class="card card-accent" style="padding:24px;">
        ...
        <div class="card-body" style="font-size:18px;">A molecular diagnosis enables precise recurrence risk estimates for future pregnancies and cascade testing of at-risk family members.</div>
      </div>
      <div class="card card-green" style="padding:24px;">
        <div class="card-title">Mechanism-Targeted Therapy</div>
        <div class="card-body" style="font-size:18px;">Genetic diagnosis unlocks therapies &mdash; e.g., mTOR inhibitors for TSC, enzyme replacement for lysosomal diseases, gene therapy for SMA.</div>
      </div>
    </div>
    <div>
      ...
      <div class="card card-amber" style="padding:24px;">
        ...
        <div class="card-body" style="font-size:18px;">Monogenic (single-gene), chromosomal disorders, and complex polygenic traits with neurological manifestations.</div>
      </div>
    </div>
  </div>
`));
...
slides.push(slideHTML(MOD, 4, TOTAL, `
  ...
  <div class="two-col">
    <div>
      <div class="card card-accent" style="padding:28px;">
        <div class="card-title" style="font-size:22px;">Monogenic (Mendelian)</div>
    ...
    <div>
      <div class="card card-violet" style="padding:28px;">
        <div class="card-title" style="font-size:22px;">Chromosomal</div>
        <div class="card-body" style="font-size:18px; margin-top:8px;">
  ...
  <div class="highlight-box" style="margin-top:20px;">
    ...
    <div class="value" style="font-size:22px;">Severe early-onset = think monogenic; dysmorphic + multi-system = think chromosomal</div>
  </div>
`));
...
slides.push(slideHTML(MOD, 5, TOTAL, `
  ...
  <div class="numbered-item">
    ...
    <div class="card card-accent" style="flex:1; margin-bottom:0; padding:20px 24px;">
      <div class="card-title" style="font-size:20px;">De Novo Variants</div>
      <div class="card-body" style="font-size:18px;">Arise spontaneously in the germline; absent in both parents. Disproportionately responsible for <strong>severe early-onset</strong> disorders &mdash; e.g., Dravet syndrome (SCN1A), KCNQ2 epileptic encephalopathy.</div>
    </div>
  </div>
  ...
  <div class="numbered-item">
    ...
    <div class="card card-green" style="flex:1; margin-bottom:0; padding:20px 24px;">
      <div class="card-title" style="font-size:20px;">Complex / Multifactorial</div>
      <div class="card-body" style="font-size:18px;">Multiple variants + environment &mdash; e.g., common epilepsy, autism spectrum disorder. Polygenic risk scores still limited in clinical use. Common late-onset dementias are predominantly polygenic.</div>
    </div>
  </div>
  ...
  <div class="numbered-item">
    ...
    <div class="card card-violet" style="flex:1; margin-bottom:0; padding:20px 24px;">
      <div class="card-title" style="font-size:20px;">Mosaicism</div>
      <div class="card-body" style="font-size:18px;">Post-zygotic mutation producing two cell populations. Severity correlates with proportion of affected cells. Can cause focal cortical dysplasia or mosaic RASopathies.</div>
    </div>
  </div>
`));
...
slides.push(slideHTML(MOD, 6, TOTAL, `
  ...
  <div class="two-col" style="margin-bottom:24px;">
    <div class="card card-accent" style="padding:28px;">
      <div class="card-title" style="font-size:24px;">Penetrance</div>
      <div class="card-body" style="font-size:19px;">The probability that a pathogenic genotype produces the clinical phenotype.</div>
      <div style="margin-top:16px; font-size:17px; color:${COLORS.muted};">
        <strong>Complete:</strong> Huntington disease (100%)<br>
        <strong>Incomplete:</strong> BRCA1 (~70% cancer risk)
      </div>
    </div>
    <div class="card card-violet" style="padding:28px;">
      <div class="card-title" style="font-size:24px;">Variable Expressivity</div>
      <div class="card-body" style="font-size:19px;">Same pathogenic variant &rarr; different severity or features across individuals.</div>
      <div style="margin-top:16px; font-size:17px; color:${COLORS.muted};">
  ...
  <div class="two-col">
    <div class="card card-green" style="padding:24px;">
      ...
      <div class="card-body" style="font-size:18px;">One gene affects multiple, seemingly unrelated phenotypes. TSC1/TSC2 &rarr; seizures, skin findings, renal tumors, cognitive effects.</div>
    </div>
    <div class="card card-amber" style="padding:24px;">
      <div class="card-title">Genetic Heterogeneity</div>
      <div class="card-body" style="font-size:18px;">One phenotype can be caused by variants in many different genes. Epileptic encephalopathy &rarr; SCN1A, KCNQ2, STXBP1, CDKL5, and 100+ others.</div>
    </div>
  </div>
`));
...
slides.push(slideHTML(MOD, 7, TOTAL, `
  ...
  <div class="two-col">
    <div>
      <div class="card card-accent" style="padding:28px;">
        <div class="card-title" style="font-size:22px;">Genetic Epilepsies</div>
        <div class="card-body" style="font-size:18px; margin-top:8px;">
          Channelopathies and signaling pathway genes dominate:
        </div>
        <div style="margin-top:14px; font-size:17px; line-height:1.7;">
    ...
    <div>
      <div class="card card-violet" style="padding:28px;">
        <div class="card-title" style="font-size:22px;">ID / Autism</div>
        <div class="card-body" style="font-size:18px; margin-top:8px;">
  ...
  <div class="two-col">
    <div>
      <div class="card card-green" style="padding:28px;">
        <div class="card-title" style="font-size:22px;">Movement Disorders</div>
        <div class="card-body" style="font-size:18px; margin-top:8px;">
    ...
    <div>
      <div class="card card-amber" style="padding:28px;">
        <div class="card-title" style="font-size:22px;">Neuromuscular</div>
        <div class="card-body" style="font-size:18px; margin-top:8px;">
...
slides.push(slideHTML(MOD, 9, TOTAL, `
  ...
  <div class="card card-red" style="padding:28px; margin-bottom:24px;">
    <div class="card-title" style="font-size:22px;">Leukodystrophies / White Matter Disorders</div>
    <div class="card-body" style="font-size:18px; margin-top:8px;">
  ...
  <div class="two-col">
    <div class="card card-accent" style="padding:24px;">
      <div class="card-title">Pleiotropy</div>
      <div class="card-body" style="font-size:18px;">The same gene can cause multiple phenotypes. The same disorder may span categories &mdash; e.g., TSC causes seizures, ID, and renal tumors.</div>
    </div>
    <div class="card card-violet" style="padding:24px;">
      <div class="card-title">Genetic Heterogeneity</div>
      <div class="card-body" style="font-size:18px;">The same phenotype can result from variants in many different genes. A focused differential requires knowing prototypical genes for each category.</div>
    </div>
  </div>
`));
...
slides.push(slideHTML(MOD, 10, TOTAL, `
  ...
  <div class="card card-accent" style="padding:28px; margin-bottom:24px;">
    <div class="card-title" style="font-size:22px;">Cornerstone of Genetic Assessment</div>
  ...
  <div style="display:grid; grid-template-columns:1fr 1fr 1fr; gap:16px;">
    <div class="card card-green" style="padding:20px;">
      <div class="card-title" style="font-size:20px;">Affected Status</div>
      <div class="card-body" style="font-size:17px;">Affected vs. unaffected, phenotypic details for affected individuals</div>
    </div>
    <div class="card card-violet" style="padding:20px;">
      <div class="card-title" style="font-size:20px;">Age &amp; Cause of Death</div>
      <div class="card-body" style="font-size:17px;">Age of onset for each affected member; cause of death if deceased</div>
    </div>
    <div class="card card-amber" style="padding:20px;">
      <div class="card-title" style="font-size:20px;">Consanguinity &amp; Ethnicity</div>
      <div class="card-body" style="font-size:17px;">Shared ancestry between parents; ethnic background for carrier frequency estimates</div>
    </div>
  </div>
`));
...
slides.push(slideHTML(MOD, 11, TOTAL, `
  ...
  <div style="display:grid; grid-template-columns:1fr 1fr; gap:20px; margin-bottom:24px;">
    <div class="card card-red" style="padding:24px;">
      <div class="card-title" style="font-size:20px;">Onset in Childhood / Adolescence</div>
      <div class="card-body" style="font-size:18px;">Early onset strongly favors a genetic etiology, especially in severe phenotypes.</div>
    </div>
    <div class="card card-accent" style="padding:24px;">
      <div class="card-title" style="font-size:20px;">Family History</div>
      <div class="card-body" style="font-size:18px;">Affected siblings (AR), parent-child transmission (AD), or maternal-line males (XLR).</div>
    </div>
    <div class="card card-violet" style="padding:24px;">
      <div class="card-title" style="font-size:20px;">ID / Developmental Delay</div>
      <div class="card-body" style="font-size:18px;">Unexplained developmental delay or intellectual disability warrants genetic testing as first-line.</div>
    </div>
    <div class="card card-amber" style="padding:24px;">
      <div class="card-title" style="font-size:20px;">Multi-Organ Involvement</div>
      <div class="card-body" style="font-size:18px;">Neurological + cardiac, renal, hepatic, or skeletal involvement suggests a pleiotropic genetic disorder.</div>
    </div>
  </div>
  ...
  <div class="two-col">
    <div class="card card-green" style="padding:24px;">
      ...
      <div class="card-body" style="font-size:18px;">Facial dysmorphism, hand anomalies, or growth abnormalities point toward chromosomal or syndromic conditions.</div>
    </div>
    <div class="card card-rose" style="padding:24px;">
      <div class="card-title">Response to Specific Therapies</div>
      <div class="card-body" style="font-size:18px;">Improvement with dietary restriction or vitamin supplementation (e.g., pyridoxine, biotin) suggests an inborn error of metabolism.</div>
    </div>
  </div>
`));
...
slides.push(slideHTML(MOD, 12, TOTAL, `
  ...
  <div class="two-col">
    <div>
      ...
      <div class="card card-accent" style="padding:22px;">
        <div class="card-title" style="font-size:20px;">Subtle Dysmorphic Features</div>
        <div class="card-body" style="font-size:17px;">Ear pits, hypertelorism, clinodactyly &mdash; easily missed on routine exam but highly informative.</div>
      </div>
      <div class="card card-green" style="padding:22px;">
        <div class="card-title" style="font-size:20px;">Skin Findings</div>
        <div class="card-body" style="font-size:17px;">Caf&eacute;-au-lait spots (NF1), ash-leaf macules (TSC), angiofibromas (TSC) &mdash; neurocutaneous stigmata.</div>
      </div>
    </div>
    ...
    <div>
      ...
      <div class="card card-violet" style="padding:22px;">
        <div class="card-title" style="font-size:20px;">Structural Clues</div>
  ...
  <div class="highlight-box" style="margin-top:20px;">
    ...
    <div class="value" style="font-size:22px;">Exam + imaging pattern recognition narrows the differential and guides the choice of genetic test</div>
  </div>
`));
...
slides.push(slideHTML(MOD, 13, TOTAL, `
  ...
  <div class="two-col">
    <div class="card card-accent" style="padding:28px;">
      <div class="card-title" style="font-size:22px;">Chromosomal Microarray (CMA)</div>
      <div class="card-body" style="font-size:18px; margin-top:8px;">
    ...
    <div class="card card-violet" style="padding:28px;">
      <div class="card-title" style="font-size:22px;">Gene Panels</div>
      <div class="card-body" style="font-size:18px; margin-top:8px;">
...
slides.push(slideHTML(MOD, 14, TOTAL, `
  ...
  <div class="three-col" style="margin-bottom:24px;">
    <div class="card card-accent" style="padding:24px;">
      <div class="card-title" style="font-size:20px;">Exome Sequencing (ES)</div>
      <div class="card-body" style="font-size:17px;">
    ...
    <div class="card card-green" style="padding:24px;">
      <div class="card-title" style="font-size:20px;">Genome Sequencing (GS)</div>
      <div class="card-body" style="font-size:17px;">
    ...
    <div class="card card-amber" style="padding:24px;">
      <div class="card-title" style="font-size:20px;">Targeted Tests</div>
      <div class="card-body" style="font-size:17px;">
  ...
  <div class="highlight-box">
    ...
    <div class="value" style="font-size:22px;">Narrow differential &rarr; targeted test or panel &nbsp;|&nbsp; Broad/unsolved &rarr; exome or genome sequencing</div>
  </div>
`));
