...
slides.push(slideHTML(MOD, 2, TOTAL, `
  ...
  <div class="stats-row" style="margin-bottom:24px;">
    <div class="stat-card" style="background:${mc.light}; border-color:${mc.accent};">
      ...
      <div class="stat-value" style="font-size:50px;">&gt;85%</div>
      <div style="font-size:22px; color:${COLORS.muted}; margin-top:4px;">have at least one psychiatric/behavioral disorder</div>
    </div>
    <div class="stat-card" style="background:${COLORS.redLight}; border-color:${COLORS.red};">
      ...
      <div class="stat-value" style="font-size:50px;">3&ndash;7&times;</div>
      <div style="font-size:22px; color:${COLORS.muted}; margin-top:4px;">higher psychiatric rates in genetic syndromes</div>
    </div>
  </div>

  <div class="two-col">
    <div class="card card-accent" style="padding:28px;">
      <div class="card-title" style="font-size:31px;">Bidirectional Relationship</div>
    ...
    <div class="card card-amber" style="padding:28px;">
      <div class="card-title" style="font-size:31px;">Medication Considerations</div>
      <div class="card-body" style="font-size:27px; line-height:1.6;">
  ...
  <div class="two-col" style="margin-top:12px;">
    <div>
      <div class="card card-red" style="padding:28px; margin-bottom:16px;">
        <div class="card-title" style="font-size:31px;">Diagnostic Overshadowing</div>
        <div class="card-body" style="font-size:27px; line-height:1.6;">
      ...
      <div class="highlight-box">
        ...
        <div class="value" style="font-size:28px;">New behavioral changes may represent communication of an untreated medical problem &mdash; always perform a medical evaluation first</div>
      </div>
    </div>

    <div>
      <div class="card card-accent" style="padding:28px;">
        <div class="card-title" style="font-size:31px;">Behavior as Communication</div>
        <div class="card-body" style="font-size:27px; line-height:1.6;">
      ...
      <div style="display:flex; flex-direction:column; gap:10px; margin-top:16px;">
        <div class="card card-amber" style="padding:16px 24px;">
          <div class="card-body" style="font-size:25px;"><strong>Aggression</strong> &rarr; Pain (dental, abdominal, musculoskeletal)</div>
        </div>
        <div class="card card-amber" style="padding:16px 24px;">
          <div class="card-body" style="font-size:25px;"><strong>Self-injury</strong> &rarr; Seizures, headache, infection (UTI, otitis)</div>
        </div>
        <div class="card card-amber" style="padding:16px 24px;">
          <div class="card-body" style="font-size:25px;"><strong>Withdrawal</strong> &rarr; Depression, mood disorder, medication side effects</div>
        </div>
      </div>
    </div>
  </div>
...
slides.push(slideHTML(MOD, 4, TOTAL, `
  ...
  <div class="two-col" style="margin-top:12px;">
    <div class="card card-red" style="padding:28px;">
      <div class="card-title" style="font-size:31px;">22q11.2 Deletion Syndrome</div>
    ...
    <div class="card card-accent" style="padding:28px;">
      <div class="card-title" style="font-size:31px;">Down Syndrome (Trisomy 21)</div>
      <div class="card-body" style="font-size:25px; line-height:1.6;">
  ...
  <div style="display:flex; flex-direction:column; gap:14px; margin-top:8px;">
    <div class="card card-violet" style="display:flex; gap:24px; padding:24px 28px;">
      <div style="flex:0 0 200px;">
        <div class="card-title" style="font-size:28px;">Williams Syndrome</div>
        <div style="font-size:22px; color:${COLORS.muted};">7q11.23 deletion (ELN)</div>
      </div>
      <div class="card-body" style="font-size:25px; flex:1;">
    ...
    <div class="card card-amber" style="display:flex; gap:24px; padding:24px 28px;">
      <div style="flex:0 0 200px;">
        <div class="card-title" style="font-size:28px;">Prader-Willi</div>
        <div style="font-size:22px; color:${COLORS.muted};">Paternal 15q11-13</div>
      </div>
      <div class="card-body" style="font-size:25px; flex:1;">
    ...
    <div class="card card-green" style="display:flex; gap:24px; padding:24px 28px;">
      <div style="flex:0 0 200px;">
        <div class="card-title" style="font-size:28px;">Angelman Syndrome</div>
        <div style="font-size:22px; color:${COLORS.muted};">Maternal UBE3A</div>
      </div>
      <div class="card-body" style="font-size:25px; flex:1;">
...
slides.push(slideHTML(MOD, 6, TOTAL, `
  ...
  <div class="card card-red" style="padding:28px; margin-bottom:20px;">
    <div class="card-title" style="font-size:31px;">Smith-Magenis Syndrome (RAI1 / 17p11.2)</div>
    <div class="card-body" style="font-size:27px; line-height:1.6;">
  ...
  <div class="two-col">
    <div class="card card-accent" style="padding:28px;">
      <div class="card-title" style="font-size:31px;">Why Behavioral Phenotypes Matter</div>
      <div class="card-body" style="font-size:27px; line-height:1.6;">
    ...
    <div class="card card-green" style="padding:28px;">
      <div class="card-title" style="font-size:31px;">Clinical Application</div>
      <div class="card-body" style="font-size:27px; line-height:1.6;">
...
slides.push(slideHTML(MOD, 7, TOTAL, `
  ...
  <div class="two-col" style="margin-top:12px;">
    <div class="card card-red" style="padding:28px;">
      <div class="card-title" style="font-size:31px;">Huntington Disease</div>
      <div class="card-body" style="font-size:27px; line-height:1.6;">
    ...
    <div class="card card-violet" style="padding:28px;">
      <div class="card-title" style="font-size:31px;">Wilson Disease</div>
      <div class="card-body" style="font-size:27px; line-height:1.6;">
...
slides.push(slideHTML(MOD, 8, TOTAL, `
  ...
  <div class="two-col" style="margin-top:12px;">
    <div class="card card-amber" style="padding:28px;">
      <div class="card-title" style="font-size:31px;">Niemann-Pick Type C (NPC)</div>
      <div class="card-body" style="font-size:27px; line-height:1.6;">
    ...
    <div class="card card-red" style="padding:28px;">
      <div class="card-title" style="font-size:31px;">22q11.2 Deletion &amp; Schizophrenia</div>
      <div class="card-body" style="font-size:27px; line-height:1.6;">
  ...
  <div class="highlight-box" style="margin-top:16px;">
    ...
    <div class="value" style="font-size:28px;">Recognizing the neurogenetic basis of psychiatric presentations &mdash; especially psychosis in young people &mdash; is critical for correct diagnosis</div>
  </div>
`));
  ...
  <div class="two-col" style="margin-top:12px;">
    <div>
      <div class="card card-accent" style="padding:28px; margin-bottom:16px;">
        <div class="card-title" style="font-size:31px;">PANS/PANDAS</div>
        <div class="card-body" style="font-size:25px; line-height:1.6;">
      ...
      <div class="card card-green" style="padding:28px;">
        <div class="card-title" style="font-size:31px;">Treatable Conditions to Screen For</div>
        <div class="card-body" style="font-size:25px; line-height:1.6;">
    ...
    <div>
      <div class="card card-red" style="padding:28px;">
        <div class="card-title" style="font-size:31px;">Red Flags for Genetic Etiology</div>
        <div class="card-body">
          <ul style="list-style:none; padding:0;">
            <li style="font-size:27px; padding:8px 0; border-bottom:1px solid ${COLORS.border};">&#x2022; Psychosis onset before age 18</li>
            <li style="font-size:27px; padding:8px 0; border-bottom:1px solid ${COLORS.border};">&#x2022; Treatment-resistant OCD or anxiety</li>
            <li style="font-size:27px; padding:8px 0; border-bottom:1px solid ${COLORS.border};">&#x2022; Psychiatric symptoms + movement disorder</li>
            <li style="font-size:27px; padding:8px 0; border-bottom:1px solid ${COLORS.border};">&#x2022; Early-onset cognitive decline</li>
            <li style="font-size:27px; padding:8px 0; border-bottom:1px solid ${COLORS.border};">&#x2022; Psychiatric + liver or renal disease</li>
            <li style="font-size:27px; padding:8px 0;">&#x2022; Family history of neurodegeneration</li>
          </ul>
        </div>
      </div>
    </div>
...
slides.push(slideHTML(MOD, 10, TOTAL, `
  ...
  <div class="two-col" style="margin-top:12px;">
    <div>
      <div class="card card-accent" style="padding:28px; margin-bottom:16px;">
        <div class="card-title" style="font-size:31px;">Adapted Assessment Tools</div>
        <div class="card-body" style="font-size:25px; line-height:1.6;">
    ...
    <div>
      <div class="card card-violet" style="padding:28px;">
        <div class="card-title" style="font-size:31px;">Genetic Workup for Psychiatric Presentation</div>
        <div class="card-body" style="font-size:25px; line-height:1.6;">
...
slides.push(slideHTML(MOD, 11, TOTAL, `
  ...
  <div style="display:flex; flex-direction:column; gap:14px; margin-top:12px;">
    <div class="card card-red" style="display:flex; gap:24px; padding:24px 28px;">
      ...
      <div style="flex:1;">
        <div class="card-title" style="font-size:29px;">EEG &mdash; Epilepsy Masquerading as Behavior</div>
        <div class="card-body" style="font-size:25px;">Epilepsy is common in neurogenetic syndromes and can manifest as behavioral change, aggression, or apparent psychiatric symptoms. <strong>Always consider and exclude seizures.</strong></div>
      </div>
    </div>
    ...
    <div class="card card-accent" style="display:flex; gap:24px; padding:24px 28px;">
      ...
      <div style="flex:1;">
        <div class="card-title" style="font-size:29px;">Brain MRI &mdash; Structural and Metabolic Clues</div>
        <div class="card-body" style="font-size:25px;">White matter changes (metabolic disease), basal ganglia lesions (Wilson, NPC), or cortical abnormalities may reveal the underlying neurogenetic cause of psychiatric presentation.</div>
      </div>
    </div>
    ...
    <div class="card card-amber" style="display:flex; gap:24px; padding:24px 28px;">
      ...
      <div style="flex:1;">
        <div class="card-title" style="font-size:29px;">Sleep Assessment &mdash; Nearly Universal in Genetic Syndromes</div>
        <div class="card-body" style="font-size:25px;">Angelman, PWS, MECP2 &mdash; all have prominent sleep disturbance. <strong>Smith-Magenis:</strong> circadian reversal. Untreated sleep disorder worsens behavioral and psychiatric symptoms. Polysomnography when clinically indicated.</div>
      </div>
    </div>
  </div>
`));
...
slides.push(slideHTML(MOD, 12, TOTAL, `
  ...
  <div class="three-col" style="margin-top:16px;">
    <div class="card card-accent" style="padding:24px;">
      <div class="card-title" style="font-size:28px;">Neurogenetics</div>
      <div class="card-body" style="font-size:24px;">Primary genetic diagnosis, genomic testing strategy, variant interpretation, family counseling</div>
    </div>
    <div class="card card-red" style="padding:24px;">
      <div class="card-title" style="font-size:28px;">Psychiatry</div>
      <div class="card-body" style="font-size:24px;">Psychiatric assessment with adapted tools, medication management adjusted for genetic context</div>
    </div>
    <div class="card card-violet" style="padding:24px;">
      <div class="card-title" style="font-size:28px;">Neuropsychology</div>
      <div class="card-body" style="font-size:24px;">Cognitive profiling, adaptive behavior assessment, monitoring for decline</div>
    </div>
  </div>

  <div class="three-col" style="margin-top:16px;">
    <div class="card card-green" style="padding:24px;">
      <div class="card-title" style="font-size:28px;">Behavioral Therapy</div>
      <div class="card-body" style="font-size:24px;">BCBA for ABA in ASD/ID, positive behavior support (PBS), functional behavioral assessment</div>
    </div>
    <div class="card card-amber" style="padding:24px;">
      <div class="card-title" style="font-size:28px;">SLP / AAC</div>
      <div class="card-body" style="font-size:24px;">Augmentative &amp; alternative communication reduces frustration-based aggression</div>
    </div>
    <div class="card card-blue" style="padding:24px;">
      <div class="card-title" style="font-size:28px;">Occupational Therapy</div>
      <div class="card-body" style="font-size:24px;">Sensory integration, adaptive skills, environmental modifications for daily functioning</div>
    </div>
  </div>

  <div class="highlight-box" style="margin-top:20px;">
    <div class="label">Key Principle</div>
    <div class="value" style="font-size:28px;">Each psychiatric comorbidity requires separate, independent management &mdash; do not subsume all symptoms under the genetic diagnosis</div>
  </div>
`));
  ...
  <table style="margin-top:12px;">
    ...
    <tbody>
      <tr>
        <td>22q11.2DS</td>
        <td>Psychosis</td>
        <td style="font-size:22px;">Antipsychotics at <strong>lower doses</strong>; clozapine for treatment-resistant</td>
        <td style="font-size:22px;">Metabolic monitoring essential (baseline metabolic risk)</td>
      </tr>
      <tr>
        <td>22q11.2DS</td>
        <td>ADHD</td>
        <td style="font-size:22px;">Methylphenidate/amphetamines first-line</td>
        <td style="font-size:22px;">Monitor for psychosis emergence</td>
      </tr>
      <tr>
        <td>Williams</td>
        <td>Anxiety/phobias</td>
        <td style="font-size:22px;">SSRIs (sertraline, fluoxetine) + behavioral therapy</td>
        <td style="font-size:22px;">Avoid high-dose daily benzodiazepines</td>
      </tr>
      <tr>
        <td>Fragile X</td>
        <td>ADHD</td>
        <td style="font-size:22px;">Methylphenidate effective (weaker RCT evidence)</td>
        <td style="font-size:22px;">Not contraindicated; monitor carefully</td>
      </tr>
      <tr>
        <td>Smith-Magenis</td>
        <td>Sleep/behavior</td>
        <td style="font-size:22px;">AM acebutolol + PM melatonin</td>
        <td style="font-size:22px;">Inverted circadian melatonin is the core defect</td>
      </tr>
    </tbody>
  </table>
`));
...
slides.push(slideHTML(MOD, 14, TOTAL, `
  ...
  <div class="three-col" style="margin-top:16px;">
    <div class="card card-accent" style="padding:28px;">
      <div class="card-title" style="font-size:31px;">Behavioral</div>
      <div class="card-body" style="font-size:25px; line-height:1.6;">
    ...
    <div class="card card-green" style="padding:28px;">
      <div class="card-title" style="font-size:31px;">Pharmacological</div>
      <div class="card-body" style="font-size:25px; line-height:1.6;">
    ...
    <div class="card card-violet" style="padding:28px;">
      <div class="card-title" style="font-size:31px;">Environmental</div>
      <div class="card-body" style="font-size:25px; line-height:1.6;">
